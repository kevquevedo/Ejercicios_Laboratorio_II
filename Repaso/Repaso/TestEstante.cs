...
namespace Repaso
{
    class TestEstante
    {
        ...
        {
            Console.Title = "Ejercicio_Repaso";
            ...
            if (estante - p1)
            {
                Console.WriteLine("Restó {0} {1} {2}", p1.GetMarca(), (string)p1, p1.GetPrecio());
            }
            else
            {
                Console.WriteLine("¡NO restó {0} {1} {2}!", p1.GetMarca(), (string)p1, p1.GetPrecio());
            }
            if (estante - p4)
            {
                Console.WriteLine("Restó {0} {1} {2}", p4.GetMarca(), (string)p4, p4.GetPrecio());
            }
            else
            {
                Console.WriteLine("¡NO restó {0} {1} {2}!", p4.GetMarca(), (string)p4, p4.GetPrecio());
            }
            if (estante + p4)
            {
                Console.WriteLine("Agregó {0} {1} {2}", p4.GetMarca(), (string)p4, p4.GetPrecio());
